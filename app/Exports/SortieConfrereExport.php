...
class SortieConfrereExport implements FromCollection, WithCustomCsvSettings, WithHeadings
{
    ...
    {
        return ['confrere','methode_echange','total','status','created_at','creer_par','type'];
    }
