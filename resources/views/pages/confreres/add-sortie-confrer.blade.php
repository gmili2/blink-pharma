                    ...
                    <section class="section-stock mt-3 pb-5">
                        <div class="row">
                            <div class="col-md-12 text-end">
                                <div class="buttons" >
                                    <a href="add-sortieconfrre" hidden  id="creer_autrre" class="btn-hover color-green">Nouvelle sortie confrère</a>
                        ...
                        <div class="section-information pt-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7 p-4 bg-white">
                                                    ...
                                                    <div class="status-vente mt-5">
                                                        <div class="row" style="    margin-left: -6px;">
                                                            <div class="col-md-8">
                                                                ...
                                                                <div class="mb-3 row">
                                                                    <label class="col-sm-2 col-form-label m-0">Méthode </label>
                                                                    <div class="col-sm-10">
                                    ...
                                    <hr class="divider" />
                                    <table id="example2" class="table table-striped mb-4" style="width: 100%;">
                                        <thead>
                                            <tr>
                                                <th>Nom</th>
                                                <th>Forme</th>
                                        ...
                                        <div class="content d-flex justify-content-between">
                                            <div>
                                                ...
                                                <div hidden id='div_quantite{{$item->id}}'>
                                                    <span>Quantité de produit {{$item->name}}: 
                                        ...
                                        <table id="table-right" class="table table-striped mb-4" style="width: 100%;">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>PPV</th>
                                                    <th>Total</th>
                                                    <th style="    padding-left: 41px;">Quantité</th>
                                                    <th></th>
                                                    {{-- <th></th> --}}
                                                </tr>
                                            </thead>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Choisir un Confrére </h5>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                <table id="listeconfrere" class="table table-striped mb-4" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <th></th>
                                            <th>Nom</th>
            ...
            <div class="modal-dialog modal-dialog-centered">
                ...
                <div class="modal fade vente-succes" id="vente-cree" tabindex="-1" aria-labelledby="" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Sortie confrère(s) crée(s) avec succés</h5> <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
...
//   alert(document.getElementById("p_unitaire"+id).value )
...
toastr.error("selectionner un confrere");
    ...
    // alert(document.getElementById("client_idsuivant").value);
...
.catch(function (error) {
    ...
    console.log(error.response.data)
            ...
            function slectclient(){
               ...
               document.getElementById("choisir_client_titre").innerHTML="choisir un Confrére"
               else 
