                                    ...
                                    <span>                             
                                        <form action="export-csv" method="POST"   enctype="multipart/form-data">
                                                            ...
                                                            <input type="text" hidden id="valuecherche" name="valuecherche">   
                                                                ...
                                                                <input type="text" hidden value="Confrere" name="table_choisie">   
                        ...
                        <div class="section-table-client mt-4 pt-3">
                            ...
                            {{-- <div class="col-md-6 mb-3">
                                <div class="form-group d-flex align-items-center">
                                    ...
                                    margin: 17px" type="text" class="form-control" placeholder="Search" id="recherch_produit"
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form id="form1" action="deleteconfrere" method="post">
                                    @method('delete')
                                    @csrf
                ...
                <script>
                    function charger_id_produit(id){
                        document.getElementById("cfr_id").value=id;
                    }
                    ...
                    function recherche_produit(){
                                ...
                                rout="gettable_confrere"+res
                                if(res=="")
                                rout="gettablee_confrere"
                                            axios.get(rout)
 ...
 $(document).ready(function () {
    // var mydattablec =  $('#examplec').DataTable({
  ...
  ,
     ...
     { "data": "id" },
          ...
          $('#examplec tbody').on( 'click','td','tr', function () {
                            var data= mydattablec.column( this ) ;
        var id= mydattablec.row( this ).data()["id"] ;
var headers = [];

   var dataTableHeaderElements = $('#examplec').DataTable().columns().header();
for (var i = 0; i< dataTableHeaderElements.length; i++) {
headers.push($(dataTableHeaderElements[i]).text())    
}    
if(headers[data[0]]!="Actions"){
     window.location.replace("/showconfrere"+id)
}
