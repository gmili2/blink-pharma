...
@section('content')  
                ...
                <div class="page-content">
                    ...
                    <section class="section-client mt-3 pb-5">
                        <form action="changepied" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="title">
                            ...
                            <div class="section-form-client mt-4">
                                <div class="block-form bg-white p-4 mb-4">
                                    <div class="section-subtitle pb-1 mb-3">
                                        <h5>Modifier le pied de page PDF</h5>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            <label class="form-label">pied *</label>
                                            <input type="file" name="pied"  required class="form-control" id="">
