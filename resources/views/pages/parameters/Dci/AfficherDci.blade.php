...
@section('content')                <div class="page-content">
    ...
    <section class="section-stock mt-3 pb-5">
        <form action="AjouterDci" method="POST"   enctype="multipart/form-data">
            ...
            <div class="section-information bg-white block-form mt-4 p-3">
                <div class="row">
                    <div class="col-md-12">
                        <div class="title-p pt-1"><h5>Créer une nouvelle Dci</h5></div>
                    </div>
                </div>
                  <div class="row mt-4 mb-4">
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Nom Dci*</label>
                        <input type="text" required class="form-control" placeholder="Nom_Dci" name="Nom_Dci" />
                    </div>
                    {{-- <div class="col-md-6 mb-3">
    ...
    <div class="col-md-6">
        <div class="title-p pt-1"><h5>Liste des DCIs</h5></div>
    </div>
    <div class="tab" >
