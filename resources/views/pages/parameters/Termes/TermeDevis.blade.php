                ...
                <div class="row mt-4 mb-4">
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control"  id="Value" name="ValueDevis" value="{{$Devis->Value}}" />
                        </div>
                    ...
                    <section class="section-client mt-3 pb-5">
                        <form  action="ModifierTermeDevis" method="POST" >
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="title">
                                        <h1>Modifier les termes et modalités par défaut des devis</h1>
                                    </div>
                                </div>
                                ...
                                <div class="block-form bg-white p-4 mb-4">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <textarea  class="form-control"   id="Value" name="ValueDevis"   cols="30" rows="5">{{$Devis->Value}}
                                            </textarea>
                                        </div>
                                    </div>
                                </div>
