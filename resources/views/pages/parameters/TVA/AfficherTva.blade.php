...
@section('content')                <div class="page-content">
    ...
    <section class="section-stock mt-3 pb-5">
        <form action="AjouterTva" method="POST"   enctype="multipart/form-data">
            ...
            <div class="section-information bg-white block-form mt-4 p-3">
                <div class="row">
                    <div class="col-md-12">
                        <div class="title-p pt-1"><h5>Créer une nouvelle TVA</h5></div>
                    </div>
                </div>
                  <div class="row mt-4 mb-4">
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Nom TVA*</label>
                        <input type="text" class="form-control" placeholder="Nom_Tva" name="Nom_Tva" />
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label"> Valeur TVA (%)*</label>
                        <input type="number" class="form-control" max="100" placeholder="Valeur" name="Valeur" />
                    </div>

                    <label class="form-label">Type*</label>
                    <div class="form-check col-md-2 mb-5 " style="margin-left:20px">
                        <input class="form-check-input" type="radio" name="Type" value="Achat">
    ...
    <div class="col-md-6">
        <div class="title-p pt-1"><h5>Liste des TVAs</h5></div>
    </div>
    <div class="tab" >
                ...
                <div class="dropdown section-action">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#search-client"
                            onclick="Remplissage('{{$item->id}}','{{$item->Nom_Tva}}','{{$item->Valeur}}','{{$item->Type}}')"
                            >modifier</a></li>

                        <li>
                            <a class="dropdown-item" href=""     data-bs-toggle="modal" data-bs-target="#modelsupprimer"
                            onclick="RemplaisageIdNom('{{$item->id}}','{{$item->Nom_Tva}}')"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <form action="ModifierTva" method="POST">
                                @csrf
                                <div class="col-md-6 mb-3">
                          <input type="text" class="form-control"  name="id" id="id"  hidden/>
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Nom TVA*</label>
                                <input type="text" class="form-control" placeholder="Nom" name="Nom_Tva" id="Nom_Tva"  />
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Valeur TVA*</label>
                            ...
                            <div class="form-check col-md-2 mb-3 " >
                                <input class="form-check-input" type="radio" name="Type" id="Achat" value="Achat">
                                <label class="form-check-label" for="conduit">
                                    sur Achat
                                </label>
                              </div>
 ...
 <div class="modal fade" id="modelsupprimer" tabindex="-1" role="dialog" aria-labelledby="modelsupprimer" aria-hidden="true">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="POST" action="DeleteTva">
                @csrf
                <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">  voullez vous vraiment Supprimer le TVA </h5>
                </div>
                <div class="modal-body">
                    <input type="text" id="NomTva"  class="form-control" >
                 ...
                 <div class="modal-body">
                    ...
                    <input type="text" id="IdTva"  name="id"  class="form-control" hidden   >
                 </div>
...
<script>
    function RemplaisageIdNom(id,Nom){
        ...
        document.getElementById("NomTva").value=Nom;
        document.getElementById("IdTva").value=id;
    ...
    function   Remplissage(id,Nom,Valeur,Type){
                            ...
                            document.getElementById("Nom_Tva").value=Nom;
