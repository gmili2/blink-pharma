...
@section('content')                <div class="page-content">
    ...
    <section class="section-stock mt-3 pb-5">
        <form action="AjouterRemise" method="POST"   enctype="multipart/form-data">
            ...
            <div class="section-information bg-white block-form mt-4 p-3">
                <div class="row">
                    <div class="col-md-12">
                        <div class="title-p pt-1"><h5>Créer une nouvelle Remise</h5></div>
                    </div>
                </div>
                  <div class="row mt-4 mb-4">
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Nom Remise*</label>
                        
                        <input type="text" required class="form-control" placeholder="Nom_Remise" name="Nom_Remise" />
                    </div>
                    <div class="col-md-6 mb-3">
    ...
    <div class="col-md-6">
        <div class="title-p pt-1"><h5>Liste des Remises</h5></div>
    </div>
    <div class="tab" >
                ...
                <div class="dropdown section-action">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#search-client"
                            onclick="Remplissage('{{$item->id}}','{{$item->Nom_Remise}}','{{$item->Valeur}}')"
                            >modifier</a></li>

                        <li>
                            <a class="dropdown-item" href=""     data-bs-toggle="modal" data-bs-target="#modelsupprimer"
                            onclick="RemplaisageIdNom('{{$item->id}}','{{$item->Nom_Remise}}')"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <form action="ModifierRemise" method="POST">
                                @csrf
                                <div class="col-md-6 mb-3">
                          <input type="text" class="form-control"  name="id" id="id"  hidden/>
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Nom Remise*</label>
                                <input type="text" class="form-control" placeholder="Nom_Remise" name="Nom_Remise" id="Nom_Remise"  />
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Valeur Remise*</label>
 ...
 <div class="modal fade" id="modelsupprimer" tabindex="-1" role="dialog" aria-labelledby="modelsupprimer" aria-hidden="true">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="POST" action="DeleteRemise">
                @csrf
                <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">  voullez vous vraiment Supprimer le Remise </h5>
                </div>
                <div class="modal-body">
                    <input type="text" id="NomRemise"  class="form-control" >
                 ...
                 <div class="modal-body">
                    ...
                    <input type="text" id="IdRemise"  name="id"  class="form-control" hidden   >
                 </div>
...
<script>
    function RemplaisageIdNom(id,Nom){
        ...
        document.getElementById("NomRemise").value=Nom;
        document.getElementById("IdRemise").value=id;
    ...
    // }
    function   Remplissage(id,Nom,Valeur){

                            document.getElementById("id").value=id;

                            document.getElementById("Nom_Remise").value=Nom;
