                                ...
                                <div class="col-md-5">
                                    <div class="block-right pt-4 pb-4 ps-2 px-2 bg-white" style="width:33%">
                                        ...
                                        <div class="content d-flex justify-content-between">
                                            <div>
                                                <h3 class="m-0">Total à restitue</h3>
                        ...
                        <div class="row">
                            <div class="col-md-12 text-end">
                                <div class="buttons">
                                    ...
                                    <a href="addretousurventepage" id="bien_ajouter" hidden class="btn-hover color-blue">Nouvelle retiur sur vente</a>
                                    ...
                                    <div class="montant-vente">
                                        <div class="detail-price">
                                            <div class="shadow-block mt-4 p-4">
                                                ...
                                                <div class="montant-recu d-flex gap-2">
                                                    <label>montant restitue </label>
                                                    <span id="montant_restitue2">0 Dhs</span>
                                                </div>
    
                                                <div class="status-vente mt-5">
                                                    <div class="row">
                                                        <div class="mb-3 row" id="montant_visible" >
                                                            <label class="col-sm-2 col-form-label m-0">Montant restitue</label>
                                                            <div class="col-sm-10">
                                                                 <input type="number" value="0" name="montant_restitue" id="montant_restitue"
...
name="mode_payment">
                    ...
                    <div class="modal fade vente-succes" id="vente-cree" tabindex="-1" aria-labelledby="" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title">retour sur Vente(s) crée(s) avec succés</h5> <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
...
var rout="ajouterretoursurvente_produit_client"
axios.post(rout, {
       qty: qty,
       pr_select: pr_select,
       ...
       montant_restitue:document.getElementById("montant_restitue").value,
  ...
  .then(function (response) {
    ...
    document.getElementById("facture_lien").href="factureretursurvente"+response.data["id_vente"]
...
function calcule_total(){
                ...
                document.getElementById("montant_restitue2").innerHTML=parseInt(total_apaye)+" Dhs";
                document.getElementById("montant_restitue").value=total_apaye;
