                ...
                <div class="page-content">
                    <section class="section-client mt-3 pb-5">
                        <div class="row text-end">
                            <div class="col-md-12">
                                @if ($organismes->credit==0)
                                <div class="buttons">
                                    {{-- <a onclick="affichermessage()" class="btn-hover color-white">Régularisation du solde</a> --}}
                                    <a href="{{url('modifierorganismepage'.$organismes->id)}}" class="btn-hover color-green">Modifier</a>
                                </div>
                                @else
                                <div class="buttons">
                            ...
                            <div class="row pb-1">
                                <div class="col-md-9">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="block-header d-flex">
                                                    <div class="image"><img src="/images/{{$organismes->image}}" style="width: 94px;" alt="" /></div>

                                                    <div class="content">
                                                        <ul>
                                                            <li><label>Nom :</label> <span>{{$organismes->nom}}</span></li>
                                                            <li><label>Téléphone :</label> <span>{{$organismes->tele}}</span></li>
                                                            {{-- <li><label>CNSS :</label> <span>{{$organismes->cnss}}</span></li> --}}
                                                            {{-- <li><label>CIN : </label> <span>{{$organismes->cin}}</span></li> --}}
                                                            <li><label>Email :</label> <span>{{$organismes->email}}</span></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                <div class="block-info">
                                                    <div class="content">
                                                        <ul>
                                                            <li><label>organisme</label> <span>{{$organismes->nom}}</span></li>
                                                            {{-- <li><label>Nom</label> <span>Client carte bancaire</span></li> --}}
                                                            {{-- <li><label>Type</label> <span>{{$organismes->type}}</span></li> --}}
                                                            {{-- <li><label>CIN</label> <span>{{$organismes->cin}}</span></li> --}}
                                                            {{-- <li><label>CNSS</label> <span>{{$organismes->cnss}}</span></li> --}}
                                                            {{-- <li><label>Plafond de crédit</label> <span>{{$organismes->plafan_credit}}</span></li> --}}
                                                            <li><label>Téléphone</label> <span>{{$organismes->tele}}</span></li>
                                                            <li><label>E-mail</label> <span>{{$organismes->email}}</span></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="block-info">
                                                    <div class="content">
                                                        <ul>
                                                            <li><label>Organisme</label> <span>{{$organismes->organisme}}</span></li>
                                                            <li><label>Numéro d'immatriculation</label> <span>{{$organismes->num_immatriculation}}</span></li>
                                                            <li><label>Numéro d’affiliaton</label> <span>{{$organismes->num_affiliation}}</span></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="block-info">
                                                    ...
                                                    <div class="content">
                                                        <ul>
                                                            <li class="full"><label>Adresse</label> <span>{{$organismes->adresse}}</span></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="block-info">
                                                    <div class="content">
                                                        <ul>
                                                            <li><label>Ville</label> <span>{{$organismes->ville}}</span></li>
                                                            <li><label>Pays</label> <span>{{$organismes->pays}}</span></li>
                                                            <li><label>Code postal</label> <span>{{$organismes->code_postal}}</span></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="block-info">
                                                    ...
                                                    <div class="content">
                                                        <ul>
                                                            <li class="full"><label>Déscreption</label> <span>{{$organismes->description}}</span></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    {{-- <div class="information-history mt-4 p-4">
                                        ...
                                        <table id="tablereg" class="table table-striped mt-3" style="width: 100%;">
                                            <thead>
                                                <tr>
                                                    <th >credit</th>
                                                    <th>montant  recue</th>
                                    ...
                                    <div class="information-history mt-4 p-4">
                                        ...
                                        <table  class="table table-striped"  id='venteofclient' style="width: 100%;">
                                            <thead>
                                                <tr>
                                                    <th>Livree</th>
    ...
    overflow-y: auto;">
                                        <div class="block-header">
                                            <div class="block">
                                                ...
                                                <div class="content px-3">
                                                    ...
                                                    <span>Dont un avoir de : 0 dh</span>
                                                </div>credit
                                                <div class="fornisseur-price"><span>{{$organismes->credit}} dh
                                                    {{-- @if (sizeof($credit)>0)
                                        ...
                                        <div class="block-information">
                                            ...
                                            <ul>
                                                ...
                                                <li><span>Créer le</span> <span>{{$organismes->created_at}}</span></li>
                                                <li class="bg-color"><span>Mise à jour par</span> <span>Dr {{$creer_par->name}}</span></li>
                                                <li><span>Mise à jour le </span> <span>2{{$organismes->updated_at}}</span></li>
                                            </ul>
                                        </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    onkeyup="calculermontantnonpaye()">
                                                     <input type="text" hidden
                                                      value=" {{$organismes->credit}}" id="creditmontant" name="creditmontant"  placeholder="montant regulire"
                                                     onkeyup="calculermontantnonpaye()">
                                                     <input type="text" hidden
                                                     value=" {{$organismes->id}}"   id="idclient" name="idclient" placeholder="montant regulire">
                                                    <br>
                                                    <br>
                                                    <br>
                                                </div>
