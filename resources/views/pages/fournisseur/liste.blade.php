...
<div class="page-content">
                                    ...
                                    <span>                             
                                        <form action="export-csv" method="POST"   enctype="multipart/form-data">
                                                            ...
                                                            <input type="text" hidden id="valuecherche" name="valuecherche">   
                                                                ...
                                                                <input type="text" hidden value="fournisseur" name="table_choisie">   
 ...
 $(document).ready(function () {
        ...
        var mydattablefornisseur =  $('#tablefornisseur').DataTable({
              dom: 'Bfrtip',
              columnDefs: [
                  {
                      targets: 1,
  ...
  ,
     ...
     { "data": "id" },
          ...
          $('#tablefornisseur tbody').on( 'click','td','tr', function () {
                            var data= mydattablefornisseur.column( this ) ;
        var id= mydattablefornisseur.row( this ).data()["id"] ;
var headers = [];

   var dataTableHeaderElements = $('#tablefornisseur').DataTable().columns().header();
for (var i = 0; i< dataTableHeaderElements.length; i++) {
headers.push($(dataTableHeaderElements[i]).text())    
}    
if(headers[data[0]]!="Actions"){
     window.location.replace("showfournisseur"+id)
}
                ...
                <script>
                    ...
                    function recherche_produit(){
                                ...
                                rout="gettable_fournisseur"+res
                                    ...
                                    axios.get(rout).then(function (response) {
