...
<html lang="en">
    <head>
        ...
        <title>BLINK PHARMA | PRODUCT</title>
    </head>
    <body>
                    ...
                    <section class="section-client mt-3 pb-5">
                        <div class="row text-end">
                            <div class="col-md-12">
                                <div class="buttons">
                                    ...
                                    <a href="addfornisseur.html" class="btn-hover color-blue">Ajouter un nouveau fournisseur</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="section-table-client mt-4 pt-3">
                            ...
                            <table id="table" class="table table-striped" style="width: 100%;">
                                ...
                                <tbody>
                                    <tr>
                                        <td>Société LD pharma</td>
                                        <td>05 74 56 46 44</td>
                                        <td>Fés</td>
                                        <td>1 097</td>
                                        <td>
                                            <div class="status">
